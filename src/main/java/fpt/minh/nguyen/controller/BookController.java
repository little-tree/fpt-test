...
public class BookController {
	...
	public String openBookditScreen(Model model, @ModelAttribute("book") Book book, BindingResult result,
			@RequestParam(name = "id") int id) {
		System.out.println(" openBookditScreen");
	...
	public String editBook(Model model, @ModelAttribute Book book, BindingResult result) throws NullBookException {
		System.out.println(" openBookRegistrationScreen");
