...
(function ($) {
    ...
    var default_options  = {
        ...
        wrongMessage : "Date is wrong format"
    };
    // fix for ie8
                        ...
                        .on('blur.xdsoft', function () {
                            if (options.allowBlank && !$.trim($(this).val()).length) {
                                ...
                                datetimepicker.data('xdsoft_datetime').empty();
                                                            ...
                                                            /* TSDV modified : 
                                                             * Auto correct date: Ymd -> Y/m/d
                                                             * Clear datebox when input incorrect date
                                                             */
...
//								}
                                                            if (Date.parseDate($(this).val(), 'Ymd') && $(this).val().length === 8){
                                                                var splittedYear = ([$(this).val()[0], $(this).val()[1], $(this).val()[2], $(this).val()[3]].join(''));
                                                                
                                                                var splittedMonth = ([$(this).val()[4], $(this).val()[5]].join(''));
                                                                var splittedDay = ([$(this).val()[6], $(this).val()[7]].join(''));
                                                                if (splittedMonth <= 12){
                                                                    $(this).val([splittedYear, splittedMonth, splittedDay].join('/'));           
                                                                } else {
                                                                    alert (default_options['wrongMessage']);
